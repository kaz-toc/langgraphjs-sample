...
export const MessageUpsertSchema = z.object({ select: MessageSelectObjectSchema.optional(), include: MessageIncludeObjectSchema.optional(), where: MessageWhereUniqueInputObjectSchema, create: z.union([ MessageCreateInputObjectSchema, MessageUncheckedCreateInputObjectSchema ]), update: z.union([ MessageUpdateInputObjectSchema, MessageUncheckedUpdateInputObjectSchema ])  })