...
export const MessageUpdateOneSchema = z.object({ select: MessageSelectObjectSchema.optional(), include: MessageIncludeObjectSchema.optional(), data: z.union([MessageUpdateInputObjectSchema, MessageUncheckedUpdateInputObjectSchema]), where: MessageWhereUniqueInputObjectSchema  })