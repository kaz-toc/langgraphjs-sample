...
export const MessageCreateOneSchema = z.object({ select: MessageSelectObjectSchema.optional(), include: MessageIncludeObjectSchema.optional(), data: z.union([MessageCreateInputObjectSchema, MessageUncheckedCreateInputObjectSchema])  })